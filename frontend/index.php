...
<head>
    <meta charset="utf-8">
    <title>Mama Tee Restaurant</title>
        ...
        <div class="container-xxl position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                <a href="index.php" class="navbar-brand p-0">
                    ...
                    <img src="images/logo_ntx.jpeg" alt="Logo"> 
                </a>
                ...
                <div class="container my-5 py-5">
                    <div class="row align-items-center g-5">
                        <div class="col-lg-6 text-center text-lg-start">
                            ...
                            <a href="categories.php" class="btn btn-primary py-sm-3 px-sm-5 me-3 animated slideInLeft">Explore Categories</a>
                        </div>
                        <div class="col-lg-6 text-center text-lg-end overflow-hidden">
                            <img class="img-fluid" src="images/logo_ntx.jpeg" alt="">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                ...
                                <p>Mama Tee Restaurant promises customers for a contactless food service.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="row g-3">
                            <div class="col-6 text-start">
                                <img class="img-fluid rounded w-100 wow zoomIn" data-wow-delay="0.1s" src="images/img/01.jpeg">
                            </div>
                            <div class="col-6 text-start">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.3s" src="images/img/02.jpeg" style="margin-top: 25%;">
                            </div>
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.5s" src="images/img/03.jpeg">
                            </div>
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-100 wow zoomIn" data-wow-delay="0.7s" src="images/img/01.jpeg">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <h5 class="section-title ff-secondary text-start text-primary fw-normal">About Us</h5>
                        <h1 class="mb-4">Welcome to <i class="fa fa-utensils text-primary me-2"></i>Mama Tee Restaurant</h1>
                        <p class="mb-4">Mama Tee began its journey from 2017 and has been one of the prominent restaurants in town ever since.Originally serving fast food in Sabon gari,
                ...
                <div class="owl-carousel testimonial-carousel">
                    <div class="testimonial-item bg-transparent border rounded p-4">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ps-3">
                                <h5 class="mb-1">Kabir Muhammad</h5>
                                <small>Student</small>
                            </div>
                        </div>
                    </div>
                    <div class="testimonial-item bg-transparent border rounded p-4">
                        <i class="fa fa-quote-left fa-2x text-primary mb-3"></i>
                        <p>I was quite amazed by their unique concept. Hats off to Mama Tee and their whole team.</p>
                        <div class="d-flex align-items-center">
                            <img class="img-fluid flex-shrink-0 rounded-circle" src="img/testimonial-2.jpg" style="width: 50px; height: 50px;">
                            <div class="ps-3">
                                <h5 class="mb-1">Tracy Roberts</h5>
                    ...
                    <div class="testimonial-item bg-transparent border rounded p-4">
                        <i class="fa fa-quote-left fa-2x text-primary mb-3"></i>
                        <p>WOW!! Exceptional concept of Mama Tee.Food quality is good, keep it up.</p>
                        <div class="d-flex align-items-center">
                            <img class="img-fluid flex-shrink-0 rounded-circle" src="img/testimonial-4.jpg" style="width: 50px; height: 50px;">
                            <div class="ps-3">
                                <h5 class="mb-1">Sadiq Abubakar</h5>
                                <small>Student</small>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container py-5">
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Sabon Gari, Kano, Nigeria</p>
                        <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>08036523838</p>
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <p>Healthy Food give better Nutrition.</p>
                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                            &copy; <a class="border-bottom" href="#">Mama Tee Restaurant</a>, All Right Reserved. 
