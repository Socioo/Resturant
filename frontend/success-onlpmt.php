...
<div class="container">
  ...
  <?php 
    ...
    if($res == true)
    { 
      $_SESSION['success'] =  "Dear ".$customer_name. ", Your Payment will be on Delivery of " .$amount. " when you recieve the food."."<br/> Transaction ID: ".$tran_id;
      header('location:'.SITEURL.'payment-redir.php');
    }
    else
    {
      $_SESSION['fail'] = "Your order is valid " .$amount. " is Not Successful."."<br/> Transaction ID: ".$tran_id ."Please Try Again";
