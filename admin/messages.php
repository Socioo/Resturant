                    ...
                    if($res == TRUE)
					{
					 $count = mysqli_num_rows($res); 
						...
						<tbody>
                            ...
                            { ?>
                                <tr>
								<td><a href=" read-message.php?id=<?php echo $id; ?>" > <?php echo "$name"; ?></a></td>
								<td><a href=" read-message.php?id=<?php echo $id; ?>" > <?php echo "$subject"; ?></a></td>
                                <td><a href=" read-message.php?id=<?php echo $id; ?>" > <?php echo "$date"; ?></a></td>
								<td>
                        			<a href=" delete-message.php?id=<?php echo $id; ?>" class="button-7" role="button" >Delete</a>
                            ...
                            else
                            {
                               ...
                               <tr>
								...
								<td><a href=" read-message.php?id=<?php echo $id; ?>" > <?php echo "<span class='unread'>$name</span>"; ?></a></td>
								<td><a href=" read-message.php?id=<?php echo $id; ?>" > <?php echo "<span class='unread'>$subject</span>"; ?></a></td>
                                <td><a href=" read-message.php?id=<?php echo $id; ?>" > <?php echo "<span class='unread'>$date</span>"; ?></a></td>
								<td>
                        			<a href=" delete-message.php?id=<?php echo $id; ?>" class="button-7" role="button" >Delete</a>
                            </div>
                    			</td>
