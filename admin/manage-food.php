...
?>
<br/>
<a href=" add-food.php" class="button-8" role="button">Add Food</a>
<br/><br/>
                    ...
                    while($row=mysqli_fetch_assoc($res))
                    {
                        ...
                        <tr>
                            ...
                            <td><?php echo $active; ?></td>
                                <td>
                                <a href=" update-food.php?id=<?php echo $id; ?>" class="button-5" role="button">Update</a>
                                <a href=" delete-food.php?id=<?php echo $id; ?>&image_name=<?php echo $image_name; ?>" class="button-7" role="button">Delete</a>
                                </td>
                        </tr>
