...
<head>
	...
	<title>Mama Tee Resturant Admin</title>
</head>
<body>
	...
	<section id="sidebar">
		<a href="index.php" class="brand">
			<img src="img/logo.jpeg" width="190px" alt="">
		</a>
	...
	<section id="content">
		...
		<br/>
            ...
            <!-- Button Add Admin-->
            <a href= "add-category.php" class="button-8" role="button">Add Category</a>
            ...
            <table class="">
                ...
                if($count > 0)
                {
                    ...
                    <td>
                        <a href=" update-category.php?id=<?php echo $id; ?>" class="button-5" role="button">Update</a>
                        <a href=" delete-category.php?id=<?php echo $id; ?>&image_name=<?php echo $image_name; ?>" class="button-7" role="button">Delete</a>
                    </td>
                </tr>
