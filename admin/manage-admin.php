...
<head>
	...
	<title>Mama Tee Restaurant Admin</title>
</head>
<body>
					 ...
					 $count = mysqli_num_rows($res); 
						...
						<tbody>
							<tr>
								...
								<td>
                        			<a href=" update-password.php?id=<?php echo $id; ?>" class="button-5" role="button">Change Password</a>
                        			<a href=" update-admin.php?id=<?php echo $id; ?>" class="button-6" role="button">Update</a>
                        			<a href=" delete-admin.php?id=<?php echo $id; ?>" class="button-7" role="button" >Delete</a>
