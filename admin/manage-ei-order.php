                            ...
                            while($row=mysqli_fetch_assoc($res))
                            {
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href=" update-ei-order.php?id=<?php echo $id; ?>" class="button-5" role="button">Update</a>
                                            <a href=" delete-ei-order.php?id=<?php echo $id; ?>" class="button-7" role="button">Delete</a>
